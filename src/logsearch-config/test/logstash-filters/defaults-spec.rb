...
describe 'Logstash filters' do
  ...
  describe "when parsing logs with AWS credentials in it" do
    when_parsing_log(
      "@type" => "syslog",
      "@message" => '<133>1 2016-06-02T16:10:00.089710+00:00 10.0.32.140 archiver - - [- job=parser index=0] {"timestamp":"1464883800.089627504","source":"ServiceBackup","message":"ServiceBackup.Running command: \u0026{Path:/var/vcap/packages/aws-cli/bin/aws Args:[/var/vcap/packages/aws-cli/bin/aws --endpoint-url https://s3.amazonaws.com s3 sync /var/vcap/store/parser/logs-to-be-archived s3://mybucket/2016/06/02] Env:[AWS_ACCESS_KEY_ID=EfAADAE0LAH2NEqUAIH1 AWS_SECRET_ACCESS_KEY=ENAEcHAH1AZ6EISHEEGAING8EnAI8PHU0Ot7OOg7] Dir: Stdin:\u003cnil\u003e Stdout:\u003cnil\u003e Stderr:\u003cnil\u003e ExtraFiles:[] SysProcAttr:\u003cnil\u003e Process:\u003cnil\u003e ProcessState:\u003cnil\u003e lookPathErr:\u003cnil\u003e finished:false childFiles:[] closeAfterStart:[] closeAfterWait:[] goroutine:[] errch:\u003cnil\u003e}\n","log_level":1,"data":{}}'
    ) do
